...
{
    flag ret = TRUE;
    ret = ((((((*(pVal)) == PID_groundsegment)) || (((*(pVal)) == PID_spacesegment)))) || (((*(pVal)) == PID_env)));
...
#ifdef __cplusplus
const asn1SccPID asn1SccPID_constant = PID_groundsegment;
#endif
...
flag asn1SccPID_Encode(const asn1SccPID* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    switch((*(pVal)))
	    {
	        case PID_groundsegment:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 0, 0, 2);
	        	break;
	        case PID_spacesegment:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 1, 0, 2);
	        	break;
	        case PID_env:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 2, 0, 2);
...

	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_PID;
	    if (ret) {
	        ...
	        {
	            case 0:
	                (*(pVal)) = PID_groundsegment;
	                break;
	            case 1:
	                (*(pVal)) = PID_spacesegment;
	                break;
	            case 2:
	                (*(pVal)) = PID_env;
	                break;
	        ...
	        (*(pVal)) = PID_groundsegment;             /*COVERAGE_IGNORE*/
	    }
	}
